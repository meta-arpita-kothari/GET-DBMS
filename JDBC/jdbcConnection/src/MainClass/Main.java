...
import BatchInsertion.BatchInsertion;
import CategoriesInParentCategory.CategoriesInParentCategory;
import CategoriesInParentCategory.CategoriesInParentCategoryPOJO;
import DeleteProduct.DeleteProduct;
import OrderDetials.OrderDetails;
import OrderDetials.OrdersDetailsPOJO;
		...
		while (true) {
			...
			try {
				...
				case 1:
					...
					System.out.println("\nEnter user id : ");
					try {
						List<OrdersDetailsPOJO> resultList = orderDetails
				...
				case 2:
					...
					try {
						Integer result = batchInsertion
								.insertBatchIntoImageTable();
						if (result == null) {
							break;
						}
				...
				System.out
						.println("Entered Incorrect username format ! Try to give an integer input.");
				scan.next();
			}
		}
